...
class V2PermissionSheetContent extends StatefulWidget {
  const V2PermissionSheetContent({
  ...
  @override
  State<V2PermissionSheetContent> createState() =>
      _V2PermissionSheetContentState();
}

class _V2PermissionSheetContentState extends State<V2PermissionSheetContent> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding:
                            const EdgeInsets.only(top: ThemeTokens.spaceXs),
                        child: Center(
                          child: Container(
                            width: 44,
                            height: 4,
